"""批量摄入 ingest/ 下所有支持的文件（public + private），打印每个文件的处理结果。
...
# 让项目根目录在 sys.path 中，保证 `src` 可导入
sys.path.insert(0, str(Path(__file__).resolve().parent.parent))

from src.config import PRIVATE_DIR, PUBLIC_DIR  # noqa: E402
from src.pipeline import process_file  # noqa: E402
from src.ingestion.state import count_by_library  # noqa: E402
