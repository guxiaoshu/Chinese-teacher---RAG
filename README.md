 ...
 **切资料不搞一刀切**：教案按课时切，错题按一道题切，文言笔记按实词 / 虚词切，作文按立意切。
 这个RAG的质量很大程度上取决于这个地方，怎么切需要后续教学研发团队详细沟通
 否则会导致： Garbage in, garbage out
 **资料进去前先贴标签**：学段、单元、篇目、知识点、类型。
...
AI 生成的教案可能有错误，需人工审核，直接存回私有库，下次检索还优先命中。可能导致越用越错的污染循环
